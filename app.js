  ...
  <div class="card mb-3 mt-3 container border-light" style="max-width: 540px;">
    ...
    <div class="">
      ...
      <div class="card-body">
        ...
        <p  class="card-text"><span class="allName">Bluetooth : </span><span class="text">${details.others?.Bluetooth ? details.others ?.Bluetooth : `no data found`}</span></p>
        <p  class="card-text"><span class="allName">GPS : </span><span class="text">${details.others?.GPS ? details.others?.GPS : `no data found`}</span></p>
        <p  class="card-text"><span class="allName">NFC : </span><span class="text">${details.others?.NFC ? details.others?.NFC : `no data found`}</span></p>
        <p  class="card-text"><span class="allName">Radio : </span><span class="text">${details.others?.Radio ? details.others?.Radio : `no data found`}</span></p>
        <p  class="card-text"><span class="allName">USB : </span><span class="text">${details.others?.USB ? details.others?.USB : `no data found`}</span></p>
        <p  class="card-text"><span class="allName">WLAN : </span><span class="text">${details.others?.WLAN ? details.others?.WLAN : `no data found`}</span></p>
      </div>
